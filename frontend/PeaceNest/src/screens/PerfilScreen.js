...
const PerfilScreen = ({ navigation }) => {
  ...
  const cerrarSesion = async () => {
    // Limpiar los datos del perfil excepto la foto
    await AsyncStorage.removeItem("perfil_nombre");
    await AsyncStorage.removeItem("perfil_descripcion");
    await AsyncStorage.removeItem("perfil_emocion");
    await AsyncStorage.removeItem("perfil_favoritos");
    await AsyncStorage.removeItem("user_points");
    await AsyncStorage.removeItem("owned_items");
  ...
  return (
    ...
    >
      ...
      {editando ? (
        ...
        <Text style={[styles.texto, { color: theme.textColor }]}>
          {nombre || "No definido"}
        </Text>
      )}
      ...
      <View style={styles.section}>
        ...
        {editando
          ...
          : favoritos.map((fav, i) => (
              <Text key={i} style={[styles.texto, { color: theme.textColor }]}>
                • {fav}
              </Text>
            ))}
      </View>
